...
![Eclipse rap download]({% asset_path "rap_download.png" %}){: width="463" height="37", .align-center}
...
![rap architecture]({% asset_path "rap_archi.png" %}){: width="521" height="158" .align-center}
...
![server centric vs client centric]({% asset_path "server_centric_client_centric.png" %}){: width="468" height="331" .align-center}
